...
def train(category_tensor, input_line_tensor, target_line_tensor):
    ...
    return output, total_loss.item() / input_line_tensor.size(0)
...
while True:
    print()
    cty = input("Category:")
    start = randomChoice(['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M', 'O', 'P', 'Q' 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z'])

    if cty in all_categories:
        print(sample(cty, start))
    else: 
